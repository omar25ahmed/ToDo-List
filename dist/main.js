...
/* harmony export */ });
function markAsCompleted(e, tasks) {
...
function clearAllCompletedTasks(tasks) {
...
/* harmony import */ var _modules_Task_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
/* harmony import */ var _modules_completed_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
if (localStorage.getItem('tasks') === null) {
  ...
  Array.from(JSON.parse(localStorage.getItem('tasks'))).forEach((task) => {
    tasks.push(new _modules_Task_js__WEBPACK_IMPORTED_MODULE_1__["default"](task.description, task.index, task.completed));
  });
}
...
form.addEventListener('submit', (e) => {
  e.preventDefault();
  const task = new _modules_Task_js__WEBPACK_IMPORTED_MODULE_1__["default"](input.value, tasks.length + 1);
  tasks.push(task);
  localStorage.setItem('tasks', JSON.stringify(tasks));
  addTask();
  input.value = '';
...
function wrapMarkAsCompleted(e) {
  (0,_modules_completed_js__WEBPACK_IMPORTED_MODULE_2__.markAsCompleted)(e, tasks);
}

ul.addEventListener('click', wrapMarkAsCompleted);

function wrapclearAllCompletedTasks() {
  (0,_modules_completed_js__WEBPACK_IMPORTED_MODULE_2__.clearAllCompletedTasks)(tasks);
}
